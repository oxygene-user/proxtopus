...
class BOTAN_PUBLIC_API(2, 0) Basic_Constraints final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_19); }

      OID oid_of() const override { return static_oid(); }

   private:
       Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_BasicConstraints); }
...
class BOTAN_PUBLIC_API(2, 0) Key_Usage final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_15); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_KeyUsage); }
...
class BOTAN_PUBLIC_API(2, 0) Subject_Key_ID final : public Certificate_Extension {
   public:
      ...
      Subject_Key_ID(const std::vector<uint8_t>& public_key, Hash_Algo hasht); /// PROXTOPUS : avoid use of strings
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_14); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_SubjectKeyIdentifier); }
...
class BOTAN_PUBLIC_API(2, 0) Authority_Key_ID final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_35); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_AuthorityKeyIdentifier); }
...
class BOTAN_PUBLIC_API(2, 4) Subject_Alternative_Name final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_17); }
   ...
   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_SubjectAlternativeName); }
...
class BOTAN_PUBLIC_API(2, 0) Issuer_Alternative_Name final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_18); }
   ...
   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_IssuerAlternativeName); }
...
class BOTAN_PUBLIC_API(2, 0) Extended_Key_Usage final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_37); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_ExtendedKeyUsage); }
...
class BOTAN_PUBLIC_API(2, 0) Name_Constraints final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_30); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_NameConstraints); }
...
class BOTAN_PUBLIC_API(2, 0) Certificate_Policies final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_32); }
   ...
   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_CertificatePolicies); }
...
class BOTAN_PUBLIC_API(2, 0) Authority_Information_Access final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_1_3_6_1_5_5_7_1_1); }
   ...
   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::PKIX_AuthorityInformationAccess); }
...
class BOTAN_PUBLIC_API(2, 0) CRL_Number final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_20); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_CRLNumber); }
...
class BOTAN_PUBLIC_API(2, 0) CRL_ReasonCode final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_21); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_ReasonCode); }
...
class BOTAN_PUBLIC_API(2, 0) CRL_Distribution_Points final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_31); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_CRLDistributionPoints); }
...
class CRL_Issuing_Distribution_Point final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_2_5_29_28); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::X509v3_CRLIssuingDistributionPoint); }
...
class OCSP_NoCheck final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_1_3_6_1_5_5_7_48_1_5); }

      OID oid_of() const override { return static_oid(); }

   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::PKIX_OCSP_NoCheck); }
...
class BOTAN_PUBLIC_API(3, 5) TNAuthList final : public Certificate_Extension {
   public:
      ...
      static OID static_oid() { return OID(oid_index::_1_3_6_1_5_5_7_1_26); }
   ...
   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::PKIX_TNAuthList); }
...
class BOTAN_PUBLIC_API(2, 4) Unknown_Extension final : public Certificate_Extension {
   ...
   private:
      Non_Algo oid_name() const override { return Non_Algo(ALG::Undefined); }
