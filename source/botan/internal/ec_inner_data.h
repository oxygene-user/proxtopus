...
class EC_Group_Data final : public std::enable_shared_from_this<EC_Group_Data> {
   public:
      ...
      std::unique_ptr<EC_AffinePoint_Data> point_hash_to_curve_ro(Hash_Algo hash_fn,
                                                                  std::span<const uint8_t> input,
                                                                  std::span<const uint8_t> domain_sep) const;

      std::unique_ptr<EC_AffinePoint_Data> point_hash_to_curve_nu(Hash_Algo hash_fn,
                                                                  std::span<const uint8_t> input,
                                                                  std::span<const uint8_t> domain_sep) const;
