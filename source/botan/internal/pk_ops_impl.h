...
class Encryption_with_EME : public Encryption {
   ...
   protected:
      explicit Encryption_with_EME(Algo_Group eme);
...
class Decryption_with_EME : public Decryption {
   ...
   protected:
      explicit Decryption_with_EME(Algo_Group eme);
...
class Verification_with_Hash : public Verification {
   ...
   protected:
      ...
      explicit Verification_with_Hash(const AlgorithmIdentifier& alg_id, Auth_Method pk_algo, bool allow_null_parameters = false);
...
class Signature_with_Hash : public Signature {
   ...
   protected:
      explicit Signature_with_Hash(Algo_Group hash);

      virtual Hash_Algo hash_function() const final { return m_hash->alg(); }
...
class Key_Agreement_with_KDF : public Key_Agreement {
   ...
   protected:
      explicit Key_Agreement_with_KDF(Algo_Group kdf);
...
class KEM_Encryption_with_KDF : public KEM_Encryption {
   ...
   protected:
      ...
      explicit KEM_Encryption_with_KDF(Algo_Group kdf);
...
class KEM_Decryption_with_KDF : public KEM_Decryption {
   ...
   protected:
      ...
      explicit KEM_Decryption_with_KDF(Algo_Group kdf);
