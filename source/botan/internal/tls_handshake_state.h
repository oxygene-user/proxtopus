...
class Handshake_State {
   public:
      ...
      */
      ...
      std::pair<Algo_Group, Signature_Format> parse_sig_format(const Public_Key& key,
                                                                Signature_Scheme scheme,
                                                                const std::vector<Signature_Scheme>& offered_schemes,
                                                                bool for_client_auth,
                                                                const Policy& policy) const;

      std::pair<Algo_Group, Signature_Format> choose_sig_format(const Private_Key& key,
                                                                 Signature_Scheme& scheme,
                                                                 bool for_client_auth,
                                                                 const Policy& policy) const;
