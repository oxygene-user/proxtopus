...
class BOTAN_TEST_API EMSA {
   public:
      ...
      */
      static std::unique_ptr<EMSA> create(Algo_Group algo_spec);
      ...
      */
      static std::unique_ptr<EMSA> create_or_throw(Algo_Group algo_spec);
      ...
      */
      virtual Hash_Algo hash_function() const = 0;

      /**
      * @return the SCAN name of the encoding/padding scheme
      */
      virtual Algo_Group name() const = 0;
};
