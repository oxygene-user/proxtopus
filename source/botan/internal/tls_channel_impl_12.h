...
class Channel_Impl_12 : public Channel_Impl {
   ...
   private:
      ...
      /* callbacks */
      Callbacks* m_callbacks = nullptr; /// PROXTOPUS : just pointer; let external code to handle ownership of this

      /* external state */
      Session_Manager* m_session_manager = nullptr; /// PROXTOPUS : just pointer; let external code to handle ownership of this
      const Policy* m_policy = nullptr; /// PROXTOPUS : just pointer; let external code to handle ownership of this
      RandomNumberGenerator* m_rng = nullptr; /// PROXTOPUS : just pointer; let external code to handle ownership of this
