...
#if 0
std::string OID::to_formatted_string1() const {
...
#endif
   auto idspan = oid_core(m_index).id;
   der.add_object(ASN1_Type::ObjectId, ASN1_Class::Universal, idspan.data(), idspan.size());
}
...
void OID::decode_from(BER_Decoder& decoder) {
   ...
   m_index = oid_find_index(obj.data());
