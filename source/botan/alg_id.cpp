...
* Create an AlgorithmIdentifier
*/
AlgorithmIdentifier::AlgorithmIdentifier(Algo_Group oid, const std::vector<uint8_t>& param) :
      AlgorithmIdentifier(OID::from_ag(oid), param) {}
...
* Create an AlgorithmIdentifier
*/
AlgorithmIdentifier::AlgorithmIdentifier(Algo_Group oid, Encoding_Option option) :
      m_oid(OID::from_ag(oid)), m_parameters() {
   const uint8_t DER_NULL[] = {0x05, 0x00};
