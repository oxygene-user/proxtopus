...
class BOTAN_PUBLIC_API(3, 0) Session_Summary : public Session_Base {
   public:
      ...
      //std::string cipher_algo() const { return ciphersuite().cipher_algo(); } /// PROXTOPUS

      //std::string mac_algo() const { return ciphersuite().mac_algo(); } /// PROXTOPUS

      //std::string prf_algo() const { return ciphersuite().prf_algo(); } /// PROXTOPUS
