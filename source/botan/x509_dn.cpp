...
std::vector<std::string> X509_DN::get_attribute(const OID& oid) const
{
...
*/
OID X509_DN::deref_info_field(std::string_view info) {

   if(info == "Name" || info == "CommonName" || info == "CN") {
       return OID(oid_index::_2_5_4_3); //"X520.CommonName";
   }
   if(info == "SerialNumber" || info == "SN") {
      return OID(oid_index::_2_5_4_5); //"X520.SerialNumber";
   }
   if(info == "Country" || info == "C") {
      return OID(oid_index::_2_5_4_6); //"X520.Country";
   }
   if(info == "Organization" || info == "O") {
      return OID(oid_index::_2_5_4_10); //"X520.Organization";
   }
   if(info == "Organizational Unit" || info == "OrgUnit" || info == "OU") {
      return OID(oid_index::_2_5_4_11); //"X520.OrganizationalUnit";
   }
   if(info == "Locality" || info == "L") {
      return OID(oid_index::_2_5_4_7); //"X520.Locality";
   }
   if(info == "State" || info == "Province" || info == "ST") {
      return OID(oid_index::_2_5_4_8); //"X520.State";
   }
   if(info == "Email" || info == "emailAddress") {
       return OID(oid_index::_1_2_840_113549_1_9_1); // "RFC822";
   }
   #ifdef _WIN32
   __debugbreak();
   #endif
