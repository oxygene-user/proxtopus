...
OID Group_Params::to_OID() const
{
    #ifdef _WIN32
    __debugbreak(); // PROXTOPUS : TODO
    #endif
    return OID::from_ag( to_alg().value() );
}

std::optional<Algo_Group> Group_Params::to_alg() const {
    switch (m_code) {
    case Group_Params::SECP256R1:
        return Algo_Group(ALG::secp256r1);
    case Group_Params::SECP384R1:
        return Algo_Group(ALG::secp384r1);
    case Group_Params::SECP521R1:
        return Algo_Group(ALG::secp521r1);
#if 0
    ...
    case Group_Params::X25519:
        return Algo_Group(ALG::X25519);
    case Group_Params::X448:
        return Algo_Group(ALG::X448);

    case Group_Params::FFDHE_2048:
        return Algo_Group(ALG::ffdhe_ietf_2048);
    case Group_Params::FFDHE_3072:
        return Algo_Group(ALG::ffdhe_ietf_3072);
    case Group_Params::FFDHE_4096:
        return Algo_Group(ALG::ffdhe_ietf_4096);
    case Group_Params::FFDHE_6144:
        return Algo_Group(ALG::ffdhe_ietf_6144);
    case Group_Params::FFDHE_8192:
        return Algo_Group(ALG::ffdhe_ietf_8192);
