   ...
   public:
      ...
      */
      PK_Key_Agreement(const Private_Key& key,
                       RandomNumberGenerator& rng,
          Algo_Group kdf);        /// PROXTOPUS : provider removed
...
class BOTAN_PUBLIC_API(2, 0) PK_KEM_Encryptor final {
   public:
      ...
      */
      /// PROXTOPUS : provider removed
      PK_KEM_Encryptor(const Public_Key& key, Algo_Group kem_param = Algo_Group());
      ...
      */
      ...
      PK_KEM_Encryptor(const Public_Key& key,
                       RandomNumberGenerator& rng,
          Algo_Group kem_param = Algo_Group()) :
            PK_KEM_Encryptor(key, kem_param) {
         BOTAN_UNUSED(rng);
      }
