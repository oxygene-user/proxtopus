...
*/
BER_Decoding_Error::BER_Decoding_Error(std::string_view str) : Decoding_Error(str::build_string("BER: $", str)) {}

BER_Bad_Tag::BER_Bad_Tag(std::string_view str, uint32_t tagging) : BER_Decoding_Error(str::build_string("$: $", str, tagging)) {}
