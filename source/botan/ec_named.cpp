/*
* ECC Group Info
* This file was automatically generated by ./src/scripts/dev_tools/gen_ec_groups.py on 2025-02-14
*
...
std::shared_ptr<EC_Group_Data> EC_Group::EC_group_info(const OID& oid) {
   // secp256r1
   if(oid == oid_index::_1_2_840_10045_3_1_7) {
   ...
   // secp384r1
   if(oid == oid_index::_1_3_132_0_34) {
      return load_EC_group_info(
   ...
   // secp521r1
   if(oid == oid_index::_1_3_132_0_35) {
      return load_EC_group_info(
   ...
   // secp224r1
   if (oid == OID(oid_index::_1_3_132_0_33)) {
       return load_EC_group_info(
...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL160R1)
   // brainpool160r1
...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL192R1)
   // brainpool192r1
...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL224R1)
   // brainpool224r1
...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL320R1)
   // brainpool320r1
...
OID EC_Group::EC_group_identity_from_order(const BigInt& order)
   ...
   if(low_bits == 0xFC632551 && order == BigInt("0xFFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551")) {
       return /*OID{1, 2, 840, 10045, 3, 1, 7};*/ OID(oid_index::_1_2_840_10045_3_1_7);
   }
   ...
   if(low_bits == 0xCCC52973 && order == BigInt("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC7634D81F4372DDF581A0DB248B0A77AECEC196ACCC52973")) {
       return /*OID{1, 3, 132, 0, 34};*/ OID(oid_index::_1_3_132_0_34);
   }
   ...
   if(low_bits == 0x91386409 && order == BigInt("0x1FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFA51868783BF2F966B7FCC0148F709A5D03BB5C9B8899C47AEBB6FB71E91386409")) {
       return /*OID{1, 3, 132, 0, 35};*/ OID(oid_index::_1_3_132_0_35);
   }

   if (low_bits == 0x5C5C2A3D && order == BigInt("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFF16A2E0B8F03E13DD29455C5C2A3D")) {
       return /*OID{1, 3, 132, 0, 33};*/ OID(oid_index::_1_3_132_0_33);
   }
