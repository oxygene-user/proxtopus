...
static BOOLEAN WinDivertUse32Bit(void)
{
    ...
    if constexpr (sizeof(void *) == sizeof(UINT64))
    {
        return FALSE;
    }
    ...
    UINT64 flags)
{
    ...
    static_assert(sizeof(WINDIVERT_DATA_NETWORK) == 8);
    static_assert(sizeof(WINDIVERT_FILTER) == 24);
    static_assert(offsetof(WINDIVERT_DATA_FLOW, Protocol) == 56);
    static_assert(offsetof(WINDIVERT_DATA_SOCKET, Protocol) == 56);
    static_assert(offsetof(WINDIVERT_DATA_REFLECT, Priority) == 24);
    static_assert(offsetof(WINDIVERT_ADDRESS, Reserved3) == 16);
    ...
    object = (WINDIVERT_FILTER *)HeapAlloc(pool, 0,
